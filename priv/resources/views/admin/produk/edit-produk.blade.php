	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Aksa Admin</span> - Edit Produk</h4>
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- Basic layout-->
						{!! Form::model($produk, ['method' => 'PATCH', 'class' => 'form-horizontal', 'action' => ['ProdukController@update', $produk->id], 'files' => true]) !!}
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										{!! Form::text('qty', null, array('class' => 'form-control touchspin-basic'),'') !!}
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										{!! Form::text('tipe_a', null, array('class' => 'form-control'),'') !!}
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										{!! Form::text('tipe_b', null, array('class' => 'form-control'),'') !!}
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										{!! Form::text('tipe_c', null, array('class' => 'form-control'),'') !!}
										</div>
									</div>
